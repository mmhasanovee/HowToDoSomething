...
{
?>
	<a href="new_reply.php?id=<?php echo $id; ?>" class="pure-material-button-contained">Reply</a>
<?php
}
else
{
...
<div class="box_login">
	<form action="login.php" method="post">
        ...
        <div class="center">
	        <input class="pure-material-button-contained"type="submit" value="Login" /> <input type="button" class="pure-material-button-contained" onclick="javascript:document.location='signup.php';" value="Sign Up" />
        </div>
    </form>
</div>
<?php
