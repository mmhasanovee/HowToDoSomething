...
(4, 'Fast foods', 'Questions about any types of fast foods.', 4),
(2, 'CSS', 'Questions about CSS codes.', 3),
(1, 'Gaming :D', 'Questions about any gaming, peripherals, accessories etc..', 1),
(5, 'Mobile Development', 'Questions about android mobile application development and Ios', 5),
(6, 'Mobile Phones', 'Questions about suggestions and so on buying a new phone.', 6),
(7, 'PC Building', 'Ask about processors, ram anything.', 7),
(9, 'Off-Topic', 'Questions about anything regrading opening a new category or any kind of off-topics can be asked.', 8);
...
(1, 1, 2, '', '::Comment has been removed due to terms violation of the website::', 3, 1566727521, 1566727521),
...
(7, 7, 1, 'How\'s Ryzen 5?', 'Is AMD processor good? Worth to buy?', 6, 1566756859, 1566756859),
(1, 8, 1, 'Need for speed Payback', 'Tell me the pc requirements?', 2, 1566792270, 1566792270);
...
(7, 'user06', '8866a3c7fe9140da1c53805f8174073197c6273f', 'user06@gmail.com', 'https://icon-library.net/images/avatar-icon/avatar-icon-5.jpg', 1566756559);
